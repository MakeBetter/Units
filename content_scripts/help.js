...
//    var browserShortcuts = null;
    ...
    var unitShortcuts = urlData && urlData.unit_shortcuts;

    var $pageShortcutsSection = $("<div></div>");
    var $unitShortcutsSection = $("<div></div>");
    ...
    if (unitShortcuts) {
        var $unitShortcutsTable = $("<table></table>").appendTo($unitShortcutsSection);
        $.each(unitShortcuts, function(key, value) {
            $("<tr></tr>")
                .appendTo($unitShortcutsTable)
